<template>
  <li class="item">
    <img
      :src="`${require('../assets/images/poster/' + review.movieImg)}`"
      alt="movie poster"
    />
    <div ref="content">
      <grade :gradeNum="review.reviewScore"></grade>
      <dl>
      ...
      <ul>
        <li>{{ review.userId }}</li>
        <li>{{ review.reviewCreated }}</li>
        <li>리뷰 삭제 <font-awesome-icon icon="caret-times" /></li>
      </ul>
...
li.item > div:nth-of-type > dl:nth-of-type(1) dt:hover + dd {
  visibility: visible;
}
